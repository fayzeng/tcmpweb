<template>
        <div v-if="modalflag">
            <Modal v-model="modalflag" width="1000" title="选择">
                ...
                <Table  border stripe class='table_com'  ref="table" @on-row-click="rowClick"  :data='tableData' :columns="tableColumns" @on-selection-change='selectRow' ></Table>
                ...
                <div slot="footer">
                    ...
                    <Button type="primary" @click="confirm('Modalform')">保存</Button>
                </div>
            </Modal>
        </div>
</template>
