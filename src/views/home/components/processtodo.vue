...
<template>
    <div>
        <Card >
            <h3 slot="title">流程待办</h3>
            <Row :gutter="16" v-for="(item,index)  in processtodoList" :key="index" class="rowstyle">
                <Col span="10" style="color:rgb(71,178,244);">
                    {{item.name}}
                </Col>
                <Col span="4">
                    {{item.name1}}
